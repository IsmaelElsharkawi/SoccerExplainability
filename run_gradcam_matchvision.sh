...
#SBATCH --output=/ibex/ai/home/saitaa0b/Projects/XMatchVision/SoccerExplainability/slurm_outputs/gradcam_matchvision-%j.out
# Run gradcam_inference.py for MatchVision
...
OUTPUT_DIR="${SOCCER_DIR}/output_gradcam_matchvision"
